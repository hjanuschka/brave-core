...
//   // WebContents in secondary devtools webview could be used by primary's
//   when
//   // active tab changes. As same WebContents could not be hold by multiple
//   // webview, it should be cleared WebContents from secondary devtools
//   webview
//   // in advance before active tab changes. Secondary devtools's WebContents
//   will
...
void SplitView::GetAccessiblePanes(BrowserViewKey,
  ...
  // if (secondary_contents_web_view() &&
  //     secondary_contents_web_view()->GetVisible()) {
  //   panes->push_back(secondary_contents_web_view());
  // }
...
void SplitView::SetSecondaryContentsResizingStrategy(
  ...
  //     secondary_contents_container_view_->GetLayoutManager())
